...
[assembly: Xamarin.Forms.ExportRenderer (typeof(LabelHeavyFont), typeof(LabelHeavyFontRenderer))]

namespace PeelseDartBond.Droid.CustomRenderers
{
    public class LabelHeavyFontRenderer : LabelRenderer
    {
        public LabelHeavyFontRenderer(Context context) : base(context)
        {
            
        }

        Typeface _typeFace = Typeface.CreateFromAsset(Application.Context.Assets, "Lato-Black.ttf");
