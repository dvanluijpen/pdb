...
[assembly: Xamarin.Forms.ExportRenderer (typeof(LabelHeavyItalicFont), typeof(LabelHeavyItalicFontRenderer))]

namespace PeelseDartBond.Droid.CustomRenderers
{
    public class LabelHeavyItalicFontRenderer : LabelRenderer
    {
        public LabelHeavyItalicFontRenderer(Context context) : base(context)
        {
            
        }

        Typeface _typeFace = Typeface.CreateFromAsset(Application.Context.Assets, "Lato-BlackItalic.ttf");
