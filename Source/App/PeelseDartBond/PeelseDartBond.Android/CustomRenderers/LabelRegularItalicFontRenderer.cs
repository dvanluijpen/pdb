...
[assembly: Xamarin.Forms.ExportRenderer (typeof(LabelRegularItalicFont), typeof(LabelRegularItalicFontRenderer))]

namespace PeelseDartBond.Droid.CustomRenderers
{
    public class LabelRegularItalicFontRenderer : LabelRenderer
    {
        public LabelRegularItalicFontRenderer(Context context) : base(context)
        {
            
        }

        Typeface _typeFace = Typeface.CreateFromAsset(Application.Context.Assets, "Lato-Italic.ttf");
