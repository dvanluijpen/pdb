...
[assembly: Xamarin.Forms.ExportRenderer (typeof(LabelHairlineFont), typeof(LabelHairlineFontRenderer))]

namespace PeelseDartBond.Droid.CustomRenderers
{
    public class LabelHairlineFontRenderer : LabelRenderer
    {
        public LabelHairlineFontRenderer(Context context) : base(context)
        {
            
        }

        Typeface _typeFace = Typeface.CreateFromAsset(Application.Context.Assets, "Lato-Hairline.ttf");
